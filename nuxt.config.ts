  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: '韓国風・エモい・かわいいユーザーネームが無限生成🌙 映える！読めないユーザーネームメーカーです！' },
        ...
        { name: 'og:description', content: '韓国風・エモい・かわいいユーザーネームが無限生成🌙 映える！読めないユーザーネームメーカーです！' },
        ...
        { name: 'twitter:description', content: '韓国風・エモい・かわいいユーザーネームが無限生成🌙 映える！読めないユーザーネームメーカーです！' },
